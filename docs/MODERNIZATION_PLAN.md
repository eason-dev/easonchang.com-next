...
- [ ] **Homepage as a bento grid**: hero card (name + animated gradient/aurora accent), interactive 3D tilt card showing the site stack, featured-projects row, latest posts with post-count link
