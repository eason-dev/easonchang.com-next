...
# Snack - Snake Game, Eat Those Dots!

[Github](https://github.com/eason-dev/100sites/tree/gh-pages/006_Snack)

[Live Demo](http://kamigami55.github.io/100sites/006_Snack/)

![Screenshot 2016-02-16 8.39.27 PM.png](https://i.imgur.com/BfDXbAU.jpg)

I had some free time today, so I finally built the snake game I'd been wanting to make, using Processing.js.

The rules are the same as classic snake: keep eating dots to grow longer and longer, but you lose if you run into yourself.

Use the arrow keys to move, and Enter to start/pause.

I'm working hard on learning how to organize my code and write proper comments, so feedback is very welcome.
