...
上一篇文章我們在自己電腦上建立的基本 Next.js 專案，程式碼在 Github 上 eason-dev/nextjs-tailwind-contentlayer-blog-starter repo 的 day02-init-nextjs branch，連結如下：
...
首先你需要將 Next.js 專案程式碼推上自己的 Github 帳號上，以我為例我是建成 [eason-dev/nextjs-tailwind-contentlayer-blog-starter](https://github.com/eason-dev/nextjs-tailwind-contentlayer-blog-starter) repo。
