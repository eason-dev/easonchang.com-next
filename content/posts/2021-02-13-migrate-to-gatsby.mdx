...
我原本的 Hexo 部落格就是架在 Github Pages 上，repo 是 [eason-dev/eason-dev.github.io](https://github.com/eason-dev/eason-dev.github.io) ，網址會是 [eason-dev.github.io](https://eason-dev.github.io) 。

另外原本就還有在 GoDaddy 上買網域指向這個位置，所以部落格最終網址會是
[https://www.easonchang.com/](https://www.easonchang.com/) 。

而我現在做的動作是把舊 repo 改名封存，重開一個新的 **eason-dev/eason-dev.github.io** repo，並把剛剛編輯好的 gatsby 專案 push 到 master branch 存放原始碼。
