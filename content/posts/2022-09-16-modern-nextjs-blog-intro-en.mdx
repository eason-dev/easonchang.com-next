...
The final result is open-sourced as the "[Next.js Tailwind Contentlayer Blog Starter](https://github.com/eason-dev/nextjs-tailwind-contentlayer-blog-starter)" template project, you can see all the code from the 30 days here:
