...
# Firework - Enjoy the Taipei 101 New Year's Fireworks

[Github](https://github.com/eason-dev/100sites/tree/gh-pages/004_Firework)

[Live Demo](http://kamigami55.github.io/100sites/004_Firework/)

![Screenshot 2016-02-15 12.08.44 AM.png](https://i.imgur.com/wHyk3xI.jpg)

I've been looking for a framework for building front-end animations, and today I finally found one: [Processing.js](http://processingjs.org). It's the js version of [Processing](https://processing.org), and it lets you build all kinds of visual arts projects.

So I used it to make today's 100sites project: Firework, a simple fireworks animation.
